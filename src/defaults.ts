...
export function defaultShop(
  ...
  return {
    ...
    interactionRange: settings.defaultInteractionRange,
    infiniteFunds: true,
...
export function sanitizeSettings(raw: unknown, lang: Lang): Settings {
  ...
  return {
    ...
    defaultInteractionRange: Math.max(
      0,
      toNumber(value.defaultInteractionRange, 0),
    ),
...
export function sanitizeShop(raw: unknown, settings: Settings): ShopData {
  ...
  return {
    ...
    interactionRange: Math.max(0, toNumber(value.interactionRange, 0)),
